var missions = [
	...
	{
		size: 7,
		desc: 'Tässä äskeinen while-silmukka on korvattu for-silmukalla, joka toimii täsmälleen samalla tavalla,mutta on nopeampi kirjoittaa. Molemmat määrittävät funktion (var x = 1;) ja  plussaavat sitä (x += 1;) niin kauan kuin ehto (x <= 5) on tosi. Muokkaa koodia hahmottaaksesi paremmin.',
		func: 'func_prev',
		example: function() {
			ruutu(2,1);
			ruutu(4,1);
